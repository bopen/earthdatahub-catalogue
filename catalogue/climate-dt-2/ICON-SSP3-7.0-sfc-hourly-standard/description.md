This dataset contains surface variables from the second generation Climate Adaptation Digital Twin of the Destination Earth initiative. It includes data from the SSP3-7.0 Scenario (2015–2040) of the ICON model. This data was regridded from the original HEALPix H128 grid to a regular latitude-longitude grid at approximately 0.44° resolution. The temporal resolution is 1 hour.
